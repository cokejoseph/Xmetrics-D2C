import type {
  ...
  OrderItem, Shipment, OrderTimeline, Payment, Exception, Integration, Return,
} from '../types'
...
export const DEMO_RETURNS: Return[] = [
  {
    id: 'ret-demo-1', brand_id: DEMO_BRAND_ID, order_id: 'ord-demo-1', customer_id: 'cust-1',
  ...
  {
    id: 'ret-demo-2', brand_id: DEMO_BRAND_ID, order_id: 'ord-demo-2', customer_id: 'cust-2',
  ...
  {
    id: 'ret-demo-3', brand_id: DEMO_BRAND_ID, order_id: 'ord-demo-3', customer_id: 'cust-3',
  ...
  {
    id: 'ret-demo-4', brand_id: DEMO_BRAND_ID, order_id: 'ord-demo-4', customer_id: 'cust-4',
  ...
  {
    id: 'ret-demo-5', brand_id: DEMO_BRAND_ID, order_id: 'ord-demo-5', customer_id: 'cust-5',
